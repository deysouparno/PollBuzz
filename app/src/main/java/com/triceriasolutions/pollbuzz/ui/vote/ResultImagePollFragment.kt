...
import com.triceriasolutions.pollbuzz.databinding.FragmentResultImagePollBinding
...
class ResultImagePollFragment : Fragment(), VoteOptionClickListener {

    private val viewModel: LandingViewModel by activityViewModels()

    private var _binding: FragmentResultImagePollBinding? = null
    private val binding: FragmentResultImagePollBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentResultImagePollBinding.inflate(inflater)
        ...
        adapter = ImageVoteAdapter(poll, this, code = 2)
    ...
    private fun loadResult() {
        ...
        binding.apply {
            ...
            totalVoteText.text = "${totalVoteText.text} ${poll.totalVote}"
        }
